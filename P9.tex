...
\input{./chapters/01.intro/intro4.tex}
\newpage
\input{./chapters/01.intro/intro_radio2.tex}
\newpage

\newpage
\input{./chapters/02.state/state.tex}
\newpage
%\input{./chapters/03.distribution/distribution.tex}
%\newpage
\input{./chapters/03.cd/cd.tex}
\newpage
\input{./chapters/06.gradient/gradients.tex}
\newpage
\input{./chapters/10.results/results.tex}
\newpage
\input{./chapters/05.pcdm/pcdm.tex}
\newpage
\input{./chapters/04.idg/idg.tex}
\newpage
\input{./chapters/80.discussion/discussion.tex}
\newpage
\input{./chapters/98.conclusion/conclusion.tex}
...
\newpage
\input{./chapters/ehrlichkeitserklaerung.tex}
