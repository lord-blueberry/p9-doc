...
We give a short introduction into how the electromagnetic wave gets measured by the interferometer, turned into visibilities and finally processed into an image. Figure \ref{intro:system} shows a radio source and its electro-magnetic (e-m) wave arriving at the antennas of the interferometer. It then shows the three processes inovlved to arrive at an image: correlation, calibration and image reconstruction.
