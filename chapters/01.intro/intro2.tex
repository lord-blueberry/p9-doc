...
\begin{alignat}{2}
\text{analysis:}\: \underset{V_2}{find}&\quad MWV_{2} = V,  \quad &x = iFFT(V_{2})
\text{synthesis:}\: \underset{V_2}{find}&\quad MWV_{2} = V,  \quad &x = iFFT(V_{2})\text{in-painting:}\: \underset{V_2}{find}&\quad MWV_{2} = V,  \quad &x = iFFT(V_{2})\\
