...
\begin{figure}[h]
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.245\linewidth}
		\includegraphics[width=\linewidth, clip, trim= 0.125in 0.125in 0.125in 0.125in]{./chapters/03.cd/simulated/psfCut.png}
		\caption{$cut(PSF)$}
	\end{subfigure}
	\begin{subfigure}[b]{0.245\linewidth}
		\includegraphics[width=\linewidth, clip, trim= 0.125in 0.125in 0.125in 0.125in]{./chapters/03.cd/simulated/psfSquaredCut.png}
...
\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth, trim= 0.125in 0.125in 0.125in 0.125in]{./chapters/03.cd/simulated/psf.png}
...
We have two methods for using an approximate the true $PSF$ with a small cutoff. 

Strong emission that overshines the rest. 

After a number of serial coordinate descent deconvolutions with the approximate $PSF$, we are inevitably going to encounter pixels with larger gradients than they should have. Figure \ref{gradient:convergence:sidelobe} shows an example cutoff of the $PSF$ and the $PSF$ values we are ignoring with the approximation.

\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth, trim= 0.125in 0.125in 0.125in 0.125in]{./chapters/03.cd/simulated/psfCut.png}
		\caption{$PSF$ cutoff}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\linewidth}
		\includegraphics[width=\linewidth, trim= 0.125in 0.125in 0.125in 0.125in]{./chapters/03.cd/simulated/psfReverseCut.png}
		\caption{Sidelobes}
	\end{subfigure}
...
\end{figure} 
 ...
 Remember that we are still in the major cycle framework, which is one of the major reasons why we can afford and approximate $PSF$ in the deconvolution problem. 

We have an implicit residual map. The residuals are implicitly represented in the gradient map. The effect of the two methods is we implicitly leave stuff in the residual map that a full $PSF$ would have removed. 
